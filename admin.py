...
def capture_fingerprint():
    ...
    print('\nFINGERPRINTS STORED: ' + str(f.getTemplateCount()) + '\n')
    ...
    try:
        ...
        if positionNumber >= 0:
            print('\nAlready exists at #' + str(positionNumber + 1) + 'Try Again (y/n): ')
            ...
            print('FINGERPRINT REGISTERED at ' + str(positionNumber + 1) + '\n')
